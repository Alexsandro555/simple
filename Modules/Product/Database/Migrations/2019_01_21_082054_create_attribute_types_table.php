...
{
  private $tableName = 'attribute_types';
  ...
  public function up()
  {
    Schema::create($this->tableName, function (Blueprint $table) {
      ...
      $table->string('title', 255)->comment('Наименование типа атрибута');
    ...
    DB::statement("ALTER TABLE `$this->tableName` comment 'Типы атрибутов'");
  }
